...
namespace ASCOM.Common.Alpaca
{
    ...
    /// </summary>
    public class IntJaggedArray2DResponse : Response, IArrayResponse<int[][]>
    {
        /// <summary>
        /// Create a new IntArray2DResponse with default values
        /// </summary>
        public IntJaggedArray2DResponse()
        {
        ...
        public IntJaggedArray2DResponse(uint clientTransactionID, uint serverTransactionID, int[][] value)
        {
        ...
        public IntJaggedArray2DResponse(uint clientTransactionID, uint serverTransactionID, string errorMessage, AlpacaErrors errorCode)
        {
            base.ServerTransactionID = serverTransactionID;
            base.ClientTransactionID = clientTransactionID;
