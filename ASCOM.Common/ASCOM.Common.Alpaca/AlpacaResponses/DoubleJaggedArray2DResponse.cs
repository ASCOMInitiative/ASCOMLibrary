...
namespace ASCOM.Common.Alpaca
{
    ...
    /// </summary>
    public class DoubleJaggedArray2DResponse : Response, IArrayResponse<double[][]>
    {
        /// <summary>
        /// Create a new DoubleArray2DResponse with default values
        /// </summary>
        public DoubleJaggedArray2DResponse()
        {
        ...
        public DoubleJaggedArray2DResponse(uint clientTransactionID, uint serverTransactionID, double[][] value)
        {
        ...
        public DoubleJaggedArray2DResponse(uint clientTransactionID, uint serverTransactionID, string errorMessage, AlpacaErrors errorCode)
        {
            base.ServerTransactionID = serverTransactionID;
            base.ClientTransactionID = clientTransactionID;
