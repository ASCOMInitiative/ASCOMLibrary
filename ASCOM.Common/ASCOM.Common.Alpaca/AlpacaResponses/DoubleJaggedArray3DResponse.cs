...
namespace ASCOM.Common.Alpaca
{
    ...
    /// </summary>
    public class DoubleJaggedArray3DResponse : Response, IArrayResponse<double[][][]>
    {
        /// <summary>
        /// Create a new DoubleArray3DResponse with default values
        /// </summary>
        public DoubleJaggedArray3DResponse()
        {
            Value = new double[0][][]; // Make sure that Value contains at least an empty array 
        }
        ...
        public DoubleJaggedArray3DResponse(uint clientTransactionID, uint serverTransactionID, double[][][] value)
        {
        ...
        public DoubleJaggedArray3DResponse(uint clientTransactionID, uint serverTransactionID, string errorMessage, AlpacaErrors errorCode)
        {
            base.ServerTransactionID = serverTransactionID;
            base.ClientTransactionID = clientTransactionID;
