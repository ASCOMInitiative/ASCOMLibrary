...
namespace ASCOM.Common.Alpaca
{
    ...
    /// </summary>
    public class ShortJaggedArray2DResponse : Response, IArrayResponse<short[][]>
    {
        /// <summary>
        /// Create a new ShortArray2DResponse with default values
        /// </summary>
        public ShortJaggedArray2DResponse()
        {
        ...
        public ShortJaggedArray2DResponse(uint clientTransactionID, uint serverTransactionID, short[][] value)
        {
        ...
        public ShortJaggedArray2DResponse(uint clientTransactionID, uint serverTransactionID, string errorMessage, AlpacaErrors errorCode)
        {
            base.ServerTransactionID = serverTransactionID;
            base.ClientTransactionID = clientTransactionID;
