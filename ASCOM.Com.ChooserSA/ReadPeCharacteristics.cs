...
namespace ASCOM.Com
{
    internal class ReadPECharacteristics : IDisposable
    {
        ...
        private readonly DriverCompatibility.Bitness ExecutableBitness;
        ...
        internal DriverCompatibility.Bitness BitNess
        {
            get
            {
