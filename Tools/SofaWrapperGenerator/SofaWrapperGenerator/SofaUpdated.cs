...
#region Sofa entry points
        ...
        /// <param name="sign">Returned sign ('+' or '-').</param>
        /// <param name="idmsf">Returned degrees, arcminutes, arcseconds, fraction (length 4).</param>
        /// <param name="ndp">Parameter.</param>
        /// <param name="angle">Parameter.</param>
        /// <param name="sign">Parameter.</param>
        /// <param name="h">Array parameter (length 4).</param>
        /// <param name="m">Parameter.</param>
        /// <param name="s">Parameter.</param>
        /// <param name="fraction">Parameter.</param>
        ...
        public static void A2af(int ndp, int ndp, double angle, double angle, out out char sign, out out char sign, unknown h, unknown h(), unknown m, unknown m, unknown s, unknown s, unknown fraction, unknown fraction)
        {
            ValidateArray(h, 4, nameof(h));

            iauA2af(ndp, angle, out sign, h, m, s, fraction);
        }
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void A2tf(int ndp, int ndp, double angle, double angle, out out char sign, out out char sign, unknown h, unknown h(), unknown m, unknown m, unknown s, unknown s, unknown fraction, unknown fraction)
        {
            ValidateArray(h, 4, nameof(h));

            iauA2tf(ndp, angle, out sign, h, m, s, fraction);
        }

        /// <summary>
        /// iauAb (P/Invoke internal)erration helper: convert position vector in star's natural system to proper
        ...
        /// <param name="bm1">Lorentz factor: sqrt(1-|v|^2).</param>
        /// <param name="ppr">Proper direction to the star.</param>
        /// <param name="pnat">Array parameter (length 3).</param>
        /// <param name="v">Array parameter (length 3).</param>
        /// <param name="s">Parameter.</param>
        /// <param name="bm1">Parameter.</param>
        /// <param name="ppr">Array parameter (length 3).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Ab(double pnat, double pnat(), double v, double v(), double s, double s, double bm1, double bm1, double ppr, double ppr())
        {
        ...
        /// <param name="ha">Returned hour angle (radians).</param>
        /// <param name="dec">Returned declination (radians).</param>
        /// <param name="az">Parameter.</param>
        /// <param name="el">Parameter.</param>
        /// <param name="phi">Parameter.</param>
        /// <param name="ha">Parameter.</param>
        /// <param name="dec">Parameter.</param>
        public static void Ae2hd(double az, double az, double el, double el, double phi, double phi, ref ref double ha, ref ref double ha, ref ref double dec, ref ref double dec)
        {
        ...
        /// </remarks>
        /// <param name="s">Parameter.</param>
        /// <param name="ideg">Parameter.</param>
        /// <param name="iamin">Parameter.</param>
        /// <param name="asec">Parameter.</param>
        /// <param name="rad">Parameter.</param>
        /// <returns>Return value from Af2a</returns>
        public static short Af2a(char s, char s, short ideg, short ideg, short iamin, short iamin, double asec, double asec, ref ref double rad, ref ref double rad)
        {
        ...
        public static double Anp(double a, double a)
        {
            return iauAnp(a);
        }
        ...
        public static double Anpm(double a, double a)
        {
            return iauAnpm(a);
        }
        ...
        /// <param name="ehp">Earth heliocentric position (length 3).</param>
        /// <param name="astrom">Returned star-independent astrometry parameters.</param>
        /// <param name="date1">Parameter.</param>
        /// <param name="date2">Parameter.</param>
        /// <param name="ebpv">Array parameter (length 6).</param>
        /// <param name="ehp">Array parameter (length 3).</param>
        /// <param name="astrom">Parameter.</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Apcg(double date1, double date1, double date2, double date2, double ebpv, double ebpv(), double ehp, double ehp(), ref ref Astrom astrom, ref ref Astrom astrom)
        {
        ...
        /// <param name="date2">Parameter.</param>
        /// <param name="astrom">Parameter.</param>
        public static void Apcg13(double date1, double date1, double date2, double date2, ref ref Astrom astrom, ref ref Astrom astrom)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Apci(double date1, double date1, double date2, double date2, double ebpv, double ebpv(), double ehp, double ehp(), double x, double x, double y, double y, double s, double s, ref ref Astrom astrom, ref ref Astrom astrom)
        {
            ValidateArray(ebpv, 6, nameof(ebpv));
            ValidateArray(ehp, 3, nameof(ehp));
        ...
        /// <param name="date2">Parameter.</param>
        /// <param name="astrom">Parameter.</param>
        /// <param name="eo">Parameter.</param>
        public static void Apci13(double date1, double date1, double date2, double date2, ref ref Astrom astrom, ref ref Astrom astrom, ref ref double eo, ref ref double eo)
        {
        ...
        /// <param name="y">Parameter.</param>
        /// <param name="s">Parameter.</param>
        /// <param name="theta">Parameter.</param>
        /// <param name="elong">Parameter.</param>
        /// <param name="phi">Parameter.</param>
        /// <param name="hm">Parameter.</param>
        /// <param name="xp">Parameter.</param>
        /// <param name="yp">Parameter.</param>
        /// <param name="sp">Parameter.</param>
        /// <param name="refa">Parameter.</param>
        /// <param name="refb">Parameter.</param>
        /// <param name="astrom">Parameter.</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Apco(double date1, double date1, double date2, double date2, double ebpv, double ebpv(), double ehp, double ehp(), double x, double x, double y, double y, double s, double s, double theta, double theta, double elong, double elong, double phi, double phi, double hm, double hm, double xp, double xp, double yp, double yp, double sp, double sp, double refa, double refa, double refb, double refb, ref ref Astrom astrom, ref ref Astrom astrom)
        {
            ValidateArray(ebpv, 6, nameof(ebpv));
            ValidateArray(ehp, 3, nameof(ehp));
        ...
        /// <param name="eo">Returned equation of the origins.</param>
        /// <returns>Status code: 0 = OK, non-zero signals a problem (see SOFA documentation).</returns>
        /// <param name="utc1">Parameter.</param>
        /// <param name="utc2">Parameter.</param>
        /// <param name="dut1">Parameter.</param>
        /// <param name="elong">Parameter.</param>
        /// <param name="phi">Parameter.</param>
        /// <param name="hm">Parameter.</param>
        /// <param name="xp">Parameter.</param>
        /// <param name="yp">Parameter.</param>
        /// <param name="phpa">Parameter.</param>
        /// <param name="tc">Parameter.</param>
        /// <param name="rh">Parameter.</param>
        /// <param name="wl">Parameter.</param>
        /// <param name="astrom">Parameter.</param>
        /// <param name="eo">Parameter.</param>
        /// <returns>Return value from Apco13</returns>
        public static int Apco13(double utc1, double utc1, double utc2, double utc2, double dut1, double dut1, double elong, double elong, double phi, double phi, double hm, double hm, double xp, double xp, double yp, double yp, double phpa, double phpa, double tc, double tc, double rh, double rh, double wl, double wl, ref ref Astrom astrom, ref ref Astrom astrom, ref ref double eo, ref ref double eo)
        {
        ...
        /// <param name="date1">Parameter.</param>
        /// <param name="date2">Parameter.</param>
        /// <param name="pv">Array parameter (length 6).</param>
        /// <param name="ebpv">Array parameter (length 6).</param>
        /// <param name="ehp">Array parameter (length 3).</param>
        /// <param name="astrom">Parameter.</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Apcs(double date1, double date1, double date2, double date2, double pv, double pv(), double ebpv, double ebpv(), double ehp, double ehp(), ref ref Astrom astrom, ref ref Astrom astrom)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Apcs13(double date1, double date1, double date2, double date2, double pv, double pv(), ref ref Astrom astrom, ref ref Astrom astrom)
        {
            ValidateArray(pv, 6, nameof(pv));
        ...
        /// <param name="theta">Parameter.</param>
        /// <param name="astrom">Parameter.</param>
        public static void Aper(double theta, double theta, ref ref Astrom astrom, ref ref Astrom astrom)
        {
        ...
        /// <param name="ut12">UT1 as a 2-part Julian Date (part 2).</param>
        /// <param name="astrom">Astrometry parameters to update.</param>
        /// <param name="ut11">Parameter.</param>
        /// <param name="ut12">Parameter.</param>
        /// <param name="astrom">Parameter.</param>
        public static void Aper13(double ut11, double ut11, double ut12, double ut12, ref ref Astrom astrom, ref ref Astrom astrom)
        {
        ...
        /// <param name="refb">Parameter.</param>
        /// <param name="astrom">Parameter.</param>
        public static void Apio(double sp, double sp, double theta, double theta, double elong, double elong, double phi, double phi, double hm, double hm, double xp, double xp, double yp, double yp, double refa, double refa, double refb, double refb, ref ref Astrom astrom, ref ref Astrom astrom)
        {
        ...
        public static int Apio13(double utc1, double utc1, double utc2, double utc2, double dut1, double dut1, double elong, double elong, double phi, double phi, double hm, double hm, double xp, double xp, double yp, double yp, double phpa, double phpa, double tc, double tc, double rh, double rh, double wl, double wl, ref ref Astrom astrom, ref ref Astrom astrom)
        {
        ...
        /// <param name="ra">Returned transformed right ascension (radians).</param>
        /// <param name="da">Returned transformed declination (radians).</param>
        /// <param name="rc">Parameter.</param>
        /// <param name="dc">Parameter.</param>
        /// <param name="pr">Parameter.</param>
        /// <param name="pd">Parameter.</param>
        /// <param name="px">Parameter.</param>
        /// <param name="rv">Parameter.</param>
        /// <param name="date1">Parameter.</param>
        /// <param name="date2">Parameter.</param>
        /// <param name="ra">Parameter.</param>
        /// <param name="da">Parameter.</param>
        public static void Atcc13(double rc, double rc, double dc, double dc, double pr, double pr, double pd, double pd, double px, double px, double rv, double rv, double date1, double date1, double date2, double date2, ref ref double ra, ref ref double ra, ref ref double da, ref ref double da)
        {
        ...
        /// <param name="ra">Parameter.</param>
        /// <param name="da">Parameter.</param>
        public static void Atccq(double rc, double rc, double dc, double dc, double pr, double pr, double pd, double pd, double px, double px, double rv, double rv, ref ref Astrom astrom, ref ref Astrom astrom, ref ref double ra, ref ref double ra, ref ref double da, ref ref double da)
        {
            iauAtccq(rc, dc, pr, pd, px, rv, ref astrom, ref ra, ref da);
        }

        /// <summary>
        /// Transform ICRS star data, epoch J2000.0, to CIRS using the SOFA iauAtci13 (P/Invoke internal) function.
        /// </summary>
        ...
        /// <param name="date1">Parameter.</param>
        /// <param name="date2">Parameter.</param>
        /// <param name="ri">Parameter.</param>
        /// <param name="di">Parameter.</param>
        /// <param name="eo">Parameter.</param>
        public static void Atci13(double rc, double rc, double dc, double dc, double pr, double pr, double pd, double pd, double px, double px, double rv, double rv, double date1, double date1, double date2, double date2, ref ref double ri, ref ref double ri, ref ref double di, ref ref double di, ref ref double eo, ref ref double eo)
        {
        ...
        /// <param name="ri">Parameter.</param>
        /// <param name="di">Parameter.</param>
        public static void Atciq(double rc, double rc, double dc, double dc, double pr, double pr, double pd, double pd, double px, double px, double rv, double rv, ref ref Astrom astrom, ref ref Astrom astrom, ref ref double ri, ref ref double ri, ref ref double di, ref ref double di)
        {
        ...
        /// <param name="rv">Parameter.</param>
        /// <param name="astrom">Parameter.</param>
        /// <param name="n">Parameter.</param>
        /// <param name="b">Parameter.</param>
        /// <param name="ri">Parameter.</param>
        /// <param name="di">Parameter.</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Atciqn(double rc, double rc, double dc, double dc, double pr, double pr, double pd, double pd, double px, double px, double rv, double rv, ref ref Astrom astrom, ref ref Astrom astrom, int n, int n, LdBody b, LdBody b(), ref ref double ri, ref ref double ri, ref ref double di, ref ref double di)
        {
        ...
        /// <param name="ri">Parameter.</param>
        /// <param name="di">Parameter.</param>
        public static void Atciqz(double rc, double rc, double dc, double dc, ref ref Astrom astrom, ref ref Astrom astrom, ref ref double ri, ref ref double ri, ref ref double di, ref ref double di)
        {
            iauAtciqz(rc, dc, ref astrom, ref ri, ref di);
        }

        /// <summary>
        /// ICRS RA,Dec to observed place using the SOFA iauAtco13 (P/Invoke internal) function.
        /// </summary>
        ...
        /// <para>Without refraction, the complementary functions iauiauAtco13 (P/Invoke internal) and iauAtoc13 are self-consistent to better than 1 microarcsecond all over the celestial sphere.  With refraction included, consistency falls off at high zenith distances, but is still better than 0.05 arcsec at 85 degrees.</para></description></item>
        ...
        /// <param name="rh">Parameter.</param>
        /// <param name="wl">Parameter.</param>
        /// <param name="aob">Parameter.</param>
        /// <param name="zob">Parameter.</param>
        /// <param name="hob">Parameter.</param>
        /// <param name="dob">Parameter.</param>
        /// <param name="rob">Parameter.</param>
        /// <param name="eo">Parameter.</param>
        /// <returns>Return value from Atco13</returns>
        public static short Atco13(double rc, double rc, double dc, double dc, double pr, double pr, double pd, double pd, double px, double px, double rv, double rv, double utc1, double utc1, double utc2, double utc2, double dut1, double dut1, double elong, double elong, double phi, double phi, double hm, double hm, double xp, double xp, double yp, double yp, double phpa, double phpa, double tc, double tc, double rh, double rh, double wl, double wl, ref ref double aob, ref ref double aob, ref ref double zob, ref ref double zob, ref ref double hob, ref ref double hob, ref ref double dob, ref ref double dob, ref ref double rob, ref ref double rob, ref ref double eo, ref ref double eo)
        {
        ...
        /// <summary>
        /// Transform star RA,Dec from geocentric CIRS to ICRS astrometric using the SOFA iauAtic13 (P/Invoke internal) function.
        /// </summary>
        /// <param name="ri">CIRS geocentric RA (radians)</param>
        /// <param name="di">CIRS geocentric Dec (radians)</param>
        ...
        /// <para>TT can be used instead of TDB without any significant impact on accuracy.</para>
        /// </description></item>
        /// <item><description>Iterative techniques are used for the aberration and light deflection corrections so that the functions iauAtic13 (P/Invoke internal) and Atci13 are accurate inverses; 
        ...
        /// <param name="dc">Parameter.</param>
        /// <param name="eo">Parameter.</param>
        public static void Atic13(double ri, double ri, double di, double di, double date1, double date1, double date2, double date2, ref ref double rc, ref ref double rc, ref ref double dc, ref ref double dc, ref ref double eo, ref ref double eo)
        {
        ...
        /// <param name="rc">Parameter.</param>
        /// <param name="dc">Parameter.</param>
        public static void Aticq(double ri, double ri, double di, double di, ref ref Astrom astrom, ref ref Astrom astrom, ref ref double rc, ref ref double rc, ref ref double dc, ref ref double dc)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Aticqn(double ri, double ri, double di, double di, ref ref Astrom astrom, ref ref Astrom astrom, int n, int n, LdBody b, LdBody b(), ref ref double rc, ref ref double rc, ref ref double dc, ref ref double dc)
        {
        ...
        /// <summary>
        /// CIRS RA,Dec to observed place using the SOFA iauAtio13 (P/Invoke internal) funciton.
        /// </summary>
        ...
        /// <item><description>The complementary functions iauiauAtio13 (P/Invoke internal) and iauAtoi13 are self-consistent to better than 1 microarcsecond all over the celestial sphere.</description></item>
        /// <item><description>It is advisable to take great care with units, as even unlikely values of the input parameters are accepted and processed in accordance with the models used.</description></item>
        /// </list>
        /// </remarks>
        ...
        /// <param name="dob">Parameter.</param>
        /// <param name="rob">Parameter.</param>
        public static void Atioq(double ri, double ri, double di, double di, ref ref Astrom astrom, ref ref Astrom astrom, ref ref double aob, ref ref double aob, ref ref double zob, ref ref double zob, ref ref double hob, ref ref double hob, ref ref double dob, ref ref double dob, ref ref double rob, ref ref double rob)
        {
            iauAtioq(ri, di, ref astrom, ref aob, ref zob, ref hob, ref dob, ref rob);
        }

        /// <summary>
        /// Observed place at a ground based site to ICRS astrometric RA,Dec using the SOFA iauAtoc13 (P/Invoke internal) function.
        /// </summary>
        ...
        private static extern short iauAtoc13(string type,
                                          double ob1,
                                          double ob2,
                                          double utc1,
                                          double utc2,
        ...
        /// <param name="ob1">Parameter.</param>
        /// <param name="ob2">Parameter.</param>
        /// <param name="utc1">Parameter.</param>
        /// <param name="utc2">Parameter.</param>
        /// <param name="dut1">Parameter.</param>
        /// <param name="elong">Parameter.</param>
        ...
        public static short Atoc13(string type, string type, double ob1, double ob1, double ob2, double ob2, double utc1, double utc1, double utc2, double utc2, double dut1, double dut1, double elong, double elong, double phi, double phi, double hm, double hm, double xp, double xp, double yp, double yp, double phpa, double phpa, double tc, double tc, double rh, double rh, double wl, double wl, ref ref double rc, ref ref double rc, ref ref double dc, ref ref double dc)
        {
            return iauAtoc13(type, ob1, ob2, utc1, utc2, dut1, elong, phi, hm, xp, yp, phpa, tc, rh, wl, ref rc, ref dc);
        }

        /// <summary>
        ///  Observed place to CIRS using the SOFA iauAtoi13 (P/Invoke internal) function.
        /// </summary>
        /// <param name="type">type of coordinates - "R", "H" or "A" (Notes 1,2)</param>
        /// <param name="ob1">observed Az, HA or RA (radians; Az is N=0,E=90)</param>
        /// <param name="ob2">observed ZD or Dec (radians)</param>
        ...
        /// <para>Without refraction, the complementary functions iauAtio13 and iauiauAtoi13 (P/Invoke internal) are self-consistent to better than 1 microarcsecond all over the celestial sphere.  With refraction included,
        ...
        private static extern short iauAtoi13(string type,
                                          double ob1,
                                          double ob2,
                                          double utc1,
                                          double utc2,
        ...
        public static short Atoi13(string type, string type, double ob1, double ob1, double ob2, double ob2, double utc1, double utc1, double utc2, double utc2, double dut1, double dut1, double elong, double elong, double phi, double phi, double hm, double hm, double xp, double xp, double yp, double yp, double phpa, double phpa, double tc, double tc, double rh, double rh, double wl, double wl, ref ref double ri, ref ref double ri, ref ref double di, ref ref double di)
        {
        ...
        private static extern void iauAtoiq(string type, double ob1, double ob2, ref Astrom astrom, ref double ri, ref double di);
        ...
        /// <param name="ri">Parameter.</param>
        /// <param name="di">Parameter.</param>
        public static void Atoiq(string type, string type, double ob1, double ob1, double ob2, double ob2, ref ref Astrom astrom, ref ref Astrom astrom, ref ref double ri, ref ref double ri, ref ref double di, ref ref double di)
        {
        ...
        /// <param name="depsbi">Returned bias-precession in obliquity.</param>
        /// <param name="dra">Returned frame bias.</param>
        /// <param name="dpsibi">Parameter.</param>
        /// <param name="depsbi">Parameter.</param>
        /// <param name="dra">Parameter.</param>
        public static void Bi00(ref ref double dpsibi, ref ref double dpsibi, ref ref double depsbi, ref ref double depsbi, ref ref double dra, ref ref double dra)
        {
        ...
        /// <param name="date1">Parameter.</param>
        /// <param name="date2">Parameter.</param>
        /// <param name="rb">Array parameter (length 9).</param>
        /// <param name="rp">Array parameter (length 9).</param>
        /// <param name="rbp">Array parameter (length 9).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Bp00(double date1, double date1, double date2, double date2, double rb, double rb(), double rp, double rp(), double rbp, double rbp())
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Bp06(double date1, double date1, double date2, double date2, double rb, double rb(), double rp, double rp(), double rbp, double rbp())
        {
            ValidateArray(rb, 9, nameof(rb));
            ValidateArray(rp, 9, nameof(rp));
            ValidateArray(rbp, 9, nameof(rbp));
        ...
        /// <param name="x">Returned X coordinate of the Celestial Intermediate Pole (GCRS).</param>
        /// <param name="y">Returned Y coordinate of the Celestial Intermediate Pole (GCRS).</param>
        /// <param name="rbpn">Array parameter (length 9).</param>
        /// <param name="x">Parameter.</param>
        /// <param name="y">Parameter.</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Bpn2xy(double rbpn, double rbpn(), ref ref double x, ref ref double x, ref ref double y, ref ref double y)
        {
        ...
        /// <param name="date1">Parameter.</param>
        /// <param name="date2">Parameter.</param>
        /// <param name="rc2">Array parameter (length 9).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void C2i00a(double date1, double date1, double date2, double date2, double rc2, double rc2())
        {
        ...
        /// <param name="date1">Parameter.</param>
        /// <param name="date2">Parameter.</param>
        /// <param name="rc2i">Array parameter (length 9).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void C2i00b(double date1, double date1, double date2, double date2, double rc2i, double rc2i())
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void C2i06a(double date1, double date1, double date2, double date2, double rc2i, double rc2i())
        {
            ValidateArray(rc2i, 9, nameof(rc2i));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void C2ibpn(double date1, double date1, double date2, double date2, double rbpn, double rbpn(), double rc2i, double rc2i())
        {
            ValidateArray(rbpn, 9, nameof(rbpn));
            ValidateArray(rc2i, 9, nameof(rc2i));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void C2ixy(double date1, double date1, double date2, double date2, double x, double x, double y, double y, double rc2i, double rc2i())
        {
            ValidateArray(rc2i, 9, nameof(rc2i));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void C2ixys(double x, double x, double y, double y, double s, double s, double rc2i, double rc2i())
        {
            ValidateArray(rc2i, 9, nameof(rc2i));
        ...
        /// <param name="theta">Returned longitude angle (radians).</param>
        /// <param name="phi">Returned latitude angle (radians).</param>
        /// <param name="p">Array parameter (length 3).</param>
        /// <param name="theta">Parameter.</param>
        /// <param name="phi">Parameter.</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void C2s(double p, double p(), ref ref double theta, ref ref double theta, ref ref double phi, ref ref double phi)
        {
        ...
        /// <param name="yp">Polar motion Y (radians).</param>
        /// <param name="rc2t">Returned ICRS-to-ITRS matrix (row-major, length 9).</param>
        /// <param name="tta">Parameter.</param>
        /// <param name="ttb">Parameter.</param>
        /// <param name="uta">Parameter.</param>
        /// <param name="utb">Parameter.</param>
        /// <param name="xp">Parameter.</param>
        /// <param name="yp">Parameter.</param>
        /// <param name="rc2t">Array parameter (length 9).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void C2t00a(double tta, double tta, double ttb, double ttb, double uta, double uta, double utb, double utb, double xp, double xp, double yp, double yp, double rc2t, double rc2t())
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void C2t00b(double tta, double tta, double ttb, double ttb, double uta, double uta, double utb, double utb, double xp, double xp, double yp, double yp, double rc2t, double rc2t())
        {
            ValidateArray(rc2t, 9, nameof(rc2t));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void C2t06a(double tta, double tta, double ttb, double ttb, double uta, double uta, double utb, double utb, double xp, double xp, double yp, double yp, double rc2t, double rc2t())
        {
            ValidateArray(rc2t, 9, nameof(rc2t));
        ...
        /// <param name="rc2t">Returned ICRS-to-ITRS matrix (row-major, length 9).</param>
        /// <param name="rc2i">Array parameter (length 9).</param>
        /// <param name="era">Parameter.</param>
        /// <param name="rpom">Array parameter (length 9).</param>
        /// <param name="rc2t">Array parameter (length 9).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void C2tcio(double rc2i, double rc2i(), double era, double era, double rpom, double rpom(), double rc2t, double rc2t())
        {
            ValidateArray(rc2i, 9, nameof(rc2i));
        ...
        /// <param name="rc2t">Returned ICRS-to-ITRS matrix (row-major, length 9).</param>
        /// <param name="rbpn">Array parameter (length 9).</param>
        /// <param name="gst">Parameter.</param>
        /// <param name="rpom">Array parameter (length 9).</param>
        /// <param name="rc2t">Array parameter (length 9).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void C2teqx(double rbpn, double rbpn(), double gst, double gst, double rpom, double rpom(), double rc2t, double rc2t())
        {
            ValidateArray(rbpn, 9, nameof(rbpn));
            ValidateArray(rpom, 9, nameof(rpom));
            ValidateArray(rc2t, 9, nameof(rc2t));
        ...
        /// <param name="uta">Parameter.</param>
        /// <param name="utb">Parameter.</param>
        /// <param name="dpsi">Parameter.</param>
        /// <param name="deps">Parameter.</param>
        /// <param name="xp">Parameter.</param>
        /// <param name="yp">Parameter.</param>
        /// <param name="rc2t">Array parameter (length 9).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void C2tpe(double tta, double tta, double ttb, double ttb, double uta, double uta, double utb, double utb, double dpsi, double dpsi, double deps, double deps, double xp, double xp, double yp, double yp, double rc2t, double rc2t())
        {
            ValidateArray(rc2t, 9, nameof(rc2t));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void C2txy(double tta, double tta, double ttb, double ttb, double uta, double uta, double utb, double utb, double x, double x, double y, double y, double xp, double xp, double yp, double yp, double rc2t, double rc2t())
        {
            ValidateArray(rc2t, 9, nameof(rc2t));
        ...
        /// <remarks>
        /// This is a P/Invoke wrapper for the SOFA <c>iauiauCal2jd (P/Invoke internal)</c> routine.
        /// </remarks>
        ...
        /// </remarks>
        /// <param name="iy">Parameter.</param>
        /// <param name="im">Parameter.</param>
        /// <param name="id">Parameter.</param>
        /// <param name="djm0">Parameter.</param>
        /// <param name="djm">Parameter.</param>
        /// <returns>Return value from Cal2jd</returns>
        public static int Cal2jd(int iy, int iy, int im, int im, int id, int id, ref ref double djm0, ref ref double djm0, ref ref double djm, ref ref double djm)
        {
        ...
        /// library function 'iauiauCp (P/Invoke internal)'.</remarks>
        ...
        /// <param name="c">The destination array that receives the copied vector. Must be a double array of length 3.</param>
        /// <param name="p">Array parameter (length 3).</param>
        /// <param name="c">Array parameter (length 3).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Cp(double p, double p(), double c, double c())
        {
            ValidateArray(p, 3, nameof(p));
        ...
        /// <param name="c">Destination position-velocity vector (length 6).</param>
        /// <param name="pv">Array parameter (length 6).</param>
        /// <param name="c">Array parameter (length 6).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Cpv(double pv, double pv(), double c, double c())
        {
            ValidateArray(pv, 6, nameof(pv));
        ...
        /// <param name="c">An array of 9 elements that receives the copied rotation matrix. Must not be null and must have a length of
        /// 9.</param>
        /// <param name="r">Array parameter (length 9).</param>
        /// <param name="c">Array parameter (length 9).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Cr(double r, double r(), double c, double c())
        {
        ...
        /// <param name="ihmsf">Returned time fields: hours, minutes, seconds, fraction.</param>
        /// <returns>Status: +1 = dubious year, 0 = OK, -1 = unacceptable date.</returns>
        /// <param name="scale">Parameter.</param>
        /// <param name="ndp">Parameter.</param>
        /// <param name="d1">Parameter.</param>
        /// <param name="d2">Parameter.</param>
        /// <param name="iy">Parameter.</param>
        /// <param name="im">Parameter.</param>
        /// <param name="id">Parameter.</param>
        /// <param name="ihmsf">Parameter.</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        /// <returns>Return value from D2dtf</returns>
        public static int D2dtf(string scale, string scale, int ndp, int ndp, double d1, double d1, double d2, double d2, ref ref int iy, ref ref int iy, ref ref int im, ref ref int im, ref ref int id, ref ref int id, int ihmsf, int ihmsf())
        {
        ...
        /// </remarks>
        /// <param name="ndp">Parameter.</param>
        /// <param name="days">Parameter.</param>
        /// <param name="sign">Parameter.</param>
        /// <param name="h">Array parameter (length 4).</param>
        /// <param name="m">Parameter.</param>
        /// <param name="s">Parameter.</param>
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void D2tf(int ndp, int ndp, double days, double days, out out char sign, out out char sign, unknown h, unknown h(), unknown m, unknown m, unknown s, unknown s, unknown fraction, unknown fraction)
        {
            ValidateArray(h, 4, nameof(h));

            iauD2tf(ndp, days, out sign, h, m, s, fraction);
        }
        ...
        /// <param name="ReturnedLeapSeconds">Out: Leap seconds</param>
        /// <returns>status: 1 = dubious year, 0 = OK, −1 = bad year, −2 = bad month, −3 = bad day, −4 = bad fraction, −5 = internal error</returns>
        /// <param name="Year">Parameter.</param>
        /// <param name="Month">Parameter.</param>
        /// <param name="Day">Parameter.</param>
        /// <param name="DayFraction">Parameter.</param>
        /// <param name="ReturnedLeapSeconds">Parameter.</param>
        /// <returns>Return value from Dat</returns>
        public static short Dat(int Year, int Year, int Month, int Month, int Day, int Day, double DayFraction, double DayFraction, ref ref double ReturnedLeapSeconds, ref ref double ReturnedLeapSeconds)
        {
        ...
        /// <param name="date1">Parameter.</param>
        /// <param name="date2">Parameter.</param>
        /// <param name="ut">Parameter.</param>
        /// <param name="elong">Parameter.</param>
        /// <param name="u">Parameter.</param>
        /// <param name="v">Parameter.</param>
        /// <returns>Return value from Dtdb</returns>
        public static double Dtdb(double date1, double date1, double date2, double date2, double ut, double ut, double elong, double elong, double u, double u, double v, double v)
        {
        ...
        private static extern short iauDtf2d(string scale, int iy, int im, int id, int ihr, int imn, double sec, ref double d1, ref double d2);
        ...
        /// <param name="im">Parameter.</param>
        /// <param name="id">Parameter.</param>
        /// <param name="ihr">Parameter.</param>
        /// <param name="imn">Parameter.</param>
        /// <param name="sec">Parameter.</param>
        /// <param name="d1">Parameter.</param>
        /// <param name="d2">Parameter.</param>
        /// <returns>Return value from Dtf2d</returns>
        public static short Dtf2d(string scale, string scale, int iy, int iy, int im, int im, int id, int id, int ihr, int ihr, int imn, int imn, double sec, double sec, ref ref double d1, ref ref double d1, ref ref double d2, ref ref double d2)
        {
        ...
        /// <param name="date1">Parameter.</param>
        /// <param name="date2">Parameter.</param>
        /// <param name="dl">Parameter.</param>
        /// <param name="db">Parameter.</param>
        /// <param name="dr">Parameter.</param>
        /// <param name="dd">Parameter.</param>
        public static void Eceq06(double date1, double date1, double date2, double date2, double dl, double dl, double db, double db, ref ref double dr, ref ref double dr, ref ref double dd, ref ref double dd)
        {
        ...
        /// <param name="date1">Parameter.</param>
        /// <param name="date2">Parameter.</param>
        /// <param name="rm">Array parameter (length 9).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Ecm06(double date1, double date1, double date2, double date2, double rm, double rm())
        {
        ...
        /// <param name="date1">Parameter.</param>
        /// <param name="date2">Parameter.</param>
        /// <param name="epsa">Parameter.</param>
        /// <param name="dpsi">Parameter.</param>
        /// <returns>Return value from Ee00</returns>
        public static double Ee00(double date1, double date1, double date2, double date2, double epsa, double epsa, double dpsi, double dpsi)
        {
        ...
        public static double Ee00a(double date1, double date1, double date2, double date2)
        {
        ...
        public static double Ee00b(double date1, double date1, double date2, double date2)
        {
        ...
        public static double Ee06a(double date1, double date1, double date2, double date2)
        {
        ...
        public static double Eect00(double date1, double date1, double date2, double date2)
        {
        ...
        public static int Eform(SofaReferenceEllipsoids n, SofaReferenceEllipsoids n, ref ref double a, ref ref double a, ref ref double f, ref ref double f)
        {
        ...
        public static double Eo06a(double date1, double date1, double date2, double date2)
        {
        ...
        /// <param name="s">CIO locator.</param>
        /// <returns>Equation of the origins in radians.</returns>
        /// <param name="rnpb">Array parameter (length 9).</param>
        /// <param name="s">Parameter.</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        /// <returns>Return value from Eors</returns>
        public static double Eors(double rnpb, double rnpb(), double s, double s)
        {
        ...
        /// <remarks>
        /// This is a P/Invoke wrapper for the SOFA <c>iauiauEpb (P/Invoke internal)</c> routine.
        /// </remarks>
        ...
        /// </remarks>
        /// <returns>Besselian epoch.</returns>
        /// <param name="dj1">Parameter.</param>
        /// <param name="dj2">Parameter.</param>
        /// <returns>Return value from Epb</returns>
        public static double Epb(double dj1, double dj1, double dj2, double dj2)
        {
        ...
        /// <remarks>
        /// This is a P/Invoke wrapper for the SOFA <c>iauiauEpb2jd (P/Invoke internal)</c> routine.
        /// </remarks>
        ...
        /// </remarks>
        /// <param name="epb">Parameter.</param>
        /// <param name="djm0">Parameter.</param>
        /// <param name="djm">Parameter.</param>
        public static void Epb2jd(double epb, double epb, ref ref double djm0, ref ref double djm0, ref ref double djm, ref ref double djm)
        {
        ...
        /// <param name="dj2">Second part of the Julian Date.</param>
        /// <remarks>
        /// This is a P/Invoke wrapper for the SOFA <c>iauiauEpj (P/Invoke internal)</c> routine.
        /// </remarks>
        ...
        public static double Epj(double dj1, double dj1, double dj2, double dj2)
        {
        ...
        /// <remarks>
        /// This is a P/Invoke wrapper for the SOFA <c>iauiauEpj2jd (P/Invoke internal)</c> routine.
        /// </remarks>
        ...
        /// </remarks>
        /// <param name="epj">Parameter.</param>
        /// <param name="djm0">Parameter.</param>
        /// <param name="djm">Parameter.</param>
        public static void Epj2jd(double epj, double epj, ref ref double djm0, ref ref double djm0, ref ref double djm, ref ref double djm)
        {
        ...
        /// <param name="date1">Parameter.</param>
        /// <param name="date2">Parameter.</param>
        /// <param name="pvh">Array parameter (length 6).</param>
        /// <param name="pvb">Array parameter (length 6).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        /// <returns>Return value from Epv00</returns>
        public static int Epv00(double date1, double date1, double date2, double date2, double pvh, double pvh(), double pvb, double pvb())
        {
        ...
        /// <param name="dl">Parameter.</param>
        /// <param name="db">Parameter.</param>
        public static void Eqec06(double date1, double date1, double date2, double date2, double dr, double dr, double dd, double dd, ref ref double dl, ref ref double dl, ref ref double db, ref ref double db)
        {
        ...
        public static double Eqeq94(double date1, double date1, double date2, double date2)
        {
        ...
        public static double Era00(double dj1, double dj1, double dj2, double dj2)
        {
        ...
        public static double Fad03(double t, double t)
        {
            return iauFad03(t);
        }
        ...
        public static double Fae03(double t, double t)
        {
            return iauFae03(t);
        }
        ...
        public static double Faf03(double t, double t)
        {
            return iauFaf03(t);
        }
        ...
        public static double Faju03(double t, double t)
        {
            return iauFaju03(t);
        }
        ...
        public static double Fal03(double t, double t)
        {
            return iauFal03(t);
        }
        ...
        public static double Falp03(double t, double t)
        {
            return iauFalp03(t);
        }
        ...
        public static double Fama03(double t, double t)
        {
            return iauFama03(t);
        }
        ...
        public static double Fame03(double t, double t)
        {
            return iauFame03(t);
        }
        ...
        public static double Fane03(double t, double t)
        {
            return iauFane03(t);
        }
        ...
        public static double Faom03(double t, double t)
        {
            return iauFaom03(t);
        }
        ...
        public static double Fapa03(double t, double t)
        {
            return iauFapa03(t);
        }
        ...
        public static double Fasa03(double t, double t)
        {
            return iauFasa03(t);
        }
        ...
        public static double Faur03(double t, double t)
        {
            return iauFaur03(t);
        }
        ...
        public static double Fave03(double t, double t)
        {
            return iauFave03(t);
        }
        ...
        /// <param name="p2000">Returned FK5 parallax (arcsec).</param>
        /// <param name="v2000">Returned FK5 radial velocity (km/s).</param>
        /// <param name="r1950">Parameter.</param>
        /// <param name="d1950">Parameter.</param>
        /// <param name="dr1950">Parameter.</param>
        /// <param name="dd1950">Parameter.</param>
        /// <param name="p1950">Parameter.</param>
        /// <param name="v1950">Parameter.</param>
        /// <param name="r2000">Parameter.</param>
        /// <param name="d2000">Parameter.</param>
        /// <param name="dr2000">Parameter.</param>
        /// <param name="dd2000">Parameter.</param>
        /// <param name="p2000">Parameter.</param>
        /// <param name="v2000">Parameter.</param>
        public static void Fk425(double r1950, double r1950, double d1950, double d1950, double dr1950, double dr1950, double dd1950, double dd1950, double p1950, double p1950, double v1950, double v1950, ref ref double r2000, ref ref double r2000, ref ref double d2000, ref ref double d2000, ref ref double dr2000, ref ref double dr2000, ref ref double dd2000, ref ref double dd2000, ref ref double p2000, ref ref double p2000, ref ref double v2000, ref ref double v2000)
        {
        ...
        /// <param name="r1950">Parameter.</param>
        /// <param name="d1950">Parameter.</param>
        /// <param name="bepoch">Parameter.</param>
        /// <param name="r2000">Parameter.</param>
        /// <param name="d2000">Parameter.</param>
        public static void Fk45z(double r1950, double r1950, double d1950, double d1950, double bepoch, double bepoch, ref ref double r2000, ref ref double r2000, ref ref double d2000, ref ref double d2000)
        {
        ...
        /// <param name="p1950">Parameter.</param>
        /// <param name="v1950">Parameter.</param>
        public static void Fk524(double r2000, double r2000, double d2000, double d2000, double dr2000, double dr2000, double dd2000, double dd2000, double p2000, double p2000, double v2000, double v2000, ref ref double r1950, ref ref double r1950, ref ref double d1950, ref ref double d1950, ref ref double dr1950, ref ref double dr1950, ref ref double dd1950, ref ref double dd1950, ref ref double p1950, ref ref double p1950, ref ref double v1950, ref ref double v1950)
        {
        ...
        /// <param name="pxh">Returned Hipparcos parallax (arcsec).</param>
        /// <param name="rvh">Returned Hipparcos radial velocity (km/s).</param>
        /// <param name="r5">Parameter.</param>
        /// <param name="d5">Parameter.</param>
        /// <param name="dr5">Parameter.</param>
        /// <param name="dd5">Parameter.</param>
        /// <param name="px5">Parameter.</param>
        /// <param name="rv5">Parameter.</param>
        /// <param name="rh">Parameter.</param>
        /// <param name="dh">Parameter.</param>
        /// <param name="drh">Parameter.</param>
        /// <param name="ddh">Parameter.</param>
        /// <param name="pxh">Parameter.</param>
        /// <param name="rvh">Parameter.</param>
        public static void Fk52h(double r5, double r5, double d5, double d5, double dr5, double dr5, double dd5, double dd5, double px5, double px5, double rv5, double rv5, ref ref double rh, ref ref double rh, ref ref double dh, ref ref double dh, ref ref double drh, ref ref double drh, ref ref double ddh, ref ref double ddh, ref ref double pxh, ref ref double pxh, ref ref double rvh, ref ref double rvh)
        {
        ...
        /// <param name="dr1950">Parameter.</param>
        /// <param name="dd1950">Parameter.</param>
        public static void Fk54z(double r2000, double r2000, double d2000, double d2000, double bepoch, double bepoch, ref ref double r1950, ref ref double r1950, ref ref double d1950, ref ref double d1950, ref ref double dr1950, ref ref double dr1950, ref ref double dd1950, ref ref double dd1950)
        {
        ...
        /// <param name="r5h">Returned FK5-to-Hipparcos rotation matrix (row-major, length 9).</param>
        /// <param name="s5h">Returned FK5-to-Hipparcos spin vector (length 3).</param>
        /// <param name="r5h">Array parameter (length 9).</param>
        /// <param name="s5h">Array parameter (length 3).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Fk5hip(double r5h, double r5h(), double s5h, double s5h())
        {
        ...
        /// <param name="rh">Parameter.</param>
        /// <param name="dh">Parameter.</param>
        public static void Fk5hz(double r5, double r5, double d5, double d5, double date1, double date1, double date2, double date2, ref ref double rh, ref ref double rh, ref ref double dh, ref ref double dh)
        {
        ...
        /// <param name="eps">Obliquity epsilon (radians).</param>
        /// <param name="r">Returned rotation matrix (row-major, length 9).</param>
        /// <param name="gamb">Parameter.</param>
        /// <param name="phib">Parameter.</param>
        /// <param name="psi">Parameter.</param>
        /// <param name="eps">Parameter.</param>
        /// <param name="r">Array parameter (length 9).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Fw2m(double gamb, double gamb, double phib, double phib, double psi, double psi, double eps, double eps, double r, double r())
        {
            ValidateArray(r, 9, nameof(r));
        ...
        /// <param name="x">Parameter.</param>
        /// <param name="y">Parameter.</param>
        public static void Fw2xy(double gamb, double gamb, double phib, double phib, double psi, double psi, double eps, double eps, ref ref double x, ref ref double x, ref ref double y, ref ref double y)
        {
        ...
        /// <param name="dr">Parameter.</param>
        /// <param name="dd">Parameter.</param>
        public static void G2icrs(double dl, double dl, double db, double db, ref ref double dr, ref ref double dr, ref ref double dd, ref ref double dd)
        {
        ...
        /// <returns>Status code: 0 = OK, &lt;0 indicates an error condition.</returns>
        /// <param name="n">Parameter.</param>
        /// <param name="xyz">Array parameter (length 3).</param>
        /// <param name="elong">Parameter.</param>
        /// <param name="phi">Parameter.</param>
        /// <param name="height">Parameter.</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        /// <returns>Return value from Gc2gd</returns>
        public static int Gc2gd(SofaReferenceEllipsoids n, SofaReferenceEllipsoids n, double xyz, double xyz(), ref ref double elong, ref ref double elong, ref ref double phi, ref ref double phi, ref ref double height, ref ref double height)
        {
        ...
        public static int Gc2gde(double a, double a, double f, double f, double xyz, double xyz(), ref ref double elong, ref ref double elong, ref ref double phi, ref ref double phi, ref ref double height, ref ref double height)
        {
            ValidateArray(xyz, 3, nameof(xyz));
        ...
        public static int Gd2gc(SofaReferenceEllipsoids n, SofaReferenceEllipsoids n, double elong, double elong, double phi, double phi, double height, double height, double xyz, double xyz())
        {
            ValidateArray(xyz, 3, nameof(xyz));
        ...
        public static int Gd2gce(double a, double a, double f, double f, double elong, double elong, double phi, double phi, double height, double height, double xyz, double xyz())
        {
            ValidateArray(xyz, 3, nameof(xyz));
        ...
        public static double Gmst00(double uta, double uta, double utb, double utb, double tta, double tta, double ttb, double ttb)
        {
        ...
        public static double Gmst06(double uta, double uta, double utb, double utb, double tta, double tta, double ttb, double ttb)
        {
        ...
        public static double Gmst82(double dj1, double dj1, double dj2, double dj2)
        {
        ...
        public static double Gst00a(double uta, double uta, double utb, double utb, double tta, double tta, double ttb, double ttb)
        {
        ...
        public static double Gst00b(double uta, double uta, double utb, double utb)
        {
        ...
        public static double Gst06(double uta, double uta, double utb, double utb, double tta, double tta, double ttb, double ttb, double rnpb, double rnpb())
        {
            ValidateArray(rnpb, 9, nameof(rnpb));
        ...
        public static double Gst06a(double uta, double uta, double utb, double utb, double tta, double tta, double ttb, double ttb)
        {
        ...
        public static double Gst94(double uta, double uta, double utb, double utb)
        {
        ...
        /// <param name="px5">Parameter.</param>
        /// <param name="rv5">Parameter.</param>
        public static void H2fk5(double rh, double rh, double dh, double dh, double drh, double drh, double ddh, double ddh, double pxh, double pxh, double rvh, double rvh, ref ref double r5, ref ref double r5, ref ref double d5, ref ref double d5, ref ref double dr5, ref ref double dr5, ref ref double dd5, ref ref double dd5, ref ref double px5, ref ref double px5, ref ref double rv5, ref ref double rv5)
        {
        ...
        /// <param name="az">Parameter.</param>
        /// <param name="el">Parameter.</param>
        public static void Hd2ae(double ha, double ha, double dec, double dec, double phi, double phi, ref ref double az, ref ref double az, ref ref double el, ref ref double el)
        {
        ...
        public static double Hd2pa(double ha, double ha, double dec, double dec, double phi, double phi)
        {
        ...
        /// <param name="dr5">Parameter.</param>
        /// <param name="dd5">Parameter.</param>
        public static void Hfk5z(double rh, double rh, double dh, double dh, double date1, double date1, double date2, double date2, ref ref double r5, ref ref double r5, ref ref double d5, ref ref double d5, ref ref double dr5, ref ref double dr5, ref ref double dd5, ref ref double dd5)
        {
        ...
        /// <param name="dl">Parameter.</param>
        /// <param name="db">Parameter.</param>
        public static void Icrs2g(double dr, double dr, double dd, double dd, ref ref double dl, ref ref double dl, ref ref double db, ref ref double db)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Ir(double r, double r())
        {
            ValidateArray(r, 9, nameof(r));
        ...
        /// <remarks>
        /// This is a P/Invoke wrapper for the SOFA <c>iauiauJd2cal (P/Invoke internal)</c> routine.
        /// </remarks>
        /// <returns>Status code: 0 = OK, &lt;0 = error.</returns>
        ...
        /// <param name="im">Parameter.</param>
        /// <param name="id">Parameter.</param>
        /// <param name="fd">Parameter.</param>
        /// <returns>Return value from Jd2cal</returns>
        public static int Jd2cal(double dj1, double dj1, double dj2, double dj2, ref ref int iy, ref ref int iy, ref ref int im, ref ref int im, ref ref int id, ref ref int id, ref ref double fd, ref ref double fd)
        {
        ...
        /// <remarks>
        /// This is a P/Invoke wrapper for the SOFA <c>iauiauJdcalf (P/Invoke internal)</c> routine.
        /// </remarks>
        /// <returns>Status code: 0 = OK, &lt;0 = error.</returns>
        ...
        /// <param name="dj1">Parameter.</param>
        /// <param name="dj2">Parameter.</param>
        /// <param name="iymdf">Parameter.</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        /// <returns>Return value from Jdcalf</returns>
        public static int Jdcalf(int ndp, int ndp, double dj1, double dj1, double dj2, double dj2, int iymdf, int iymdf())
        {
        ...
        /// <param name="dlim">Deflection limiter.</param>
        /// <param name="p1">Returned deflected direction (length 3).</param>
        /// <param name="bm">Parameter.</param>
        /// <param name="p">Array parameter (length 3).</param>
        /// <param name="q">Array parameter (length 3).</param>
        /// <param name="e">Array parameter (length 3).</param>
        /// <param name="em">Parameter.</param>
        /// <param name="dlim">Parameter.</param>
        /// <param name="p1">Array parameter (length 3).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Ld(double bm, double bm, double p, double p(), double q, double q(), double e, double e(), double em, double em, double dlim, double dlim, double p1, double p1())
        {
            ValidateArray(p, 3, nameof(p));
        ...
        /// <param name="n">Parameter.</param>
        /// <param name="b">Parameter.</param>
        /// <param name="ob">Array parameter (length 3).</param>
        /// <param name="sc">Array parameter (length 3).</param>
        /// <param name="sn">Array parameter (length 3).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Ldn(int n, int n, LdBody b, LdBody b(), double ob, double ob(), double sc, double sc(), double sn, double sn())
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Ldsun(double p, double p(), double e, double e(), double em, double em, double p1, double p1())
        {
            ValidateArray(p, 3, nameof(p));
            ValidateArray(e, 3, nameof(e));
            ValidateArray(p1, 3, nameof(p1));
        ...
        /// <param name="dr">Parameter.</param>
        /// <param name="dd">Parameter.</param>
        public static void Lteceq(double epj, double epj, double dl, double dl, double db, double db, ref ref double dr, ref ref double dr, ref ref double dd, ref ref double dd)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Ltecm(double epj, double epj, double rm, double rm())
        {
            ValidateArray(rm, 9, nameof(rm));
        ...
        /// <param name="dl">Parameter.</param>
        /// <param name="db">Parameter.</param>
        public static void Lteqec(double epj, double epj, double dr, double dr, double dd, double dd, ref ref double dl, ref ref double dl, ref ref double db, ref ref double db)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Ltp(double epj, double epj, double rp, double rp())
        {
            ValidateArray(rp, 9, nameof(rp));
        ...
        /// <param name="rpb">Returned precession matrix including E-terms (row-major, length 9).</param>
        /// <param name="epj">Parameter.</param>
        /// <param name="rpb">Array parameter (length 9).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Ltpb(double epj, double epj, double rpb, double rpb())
        {
        ...
        /// <param name="vec">Returned transformed vector (length 3).</param>
        /// <param name="epj">Parameter.</param>
        /// <param name="vec">Array parameter (length 3).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Ltpecl(double epj, double epj, double vec, double vec())
        {
        ...
        /// <param name="veq">Returned transformed vector (length 3).</param>
        /// <param name="epj">Parameter.</param>
        /// <param name="veq">Array parameter (length 3).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Ltpequ(double epj, double epj, double veq, double veq())
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Moon98(double date1, double date1, double date2, double date2, double pv, double pv())
        {
            ValidateArray(pv, 6, nameof(pv));
        ...
        /// <param name="date1">Parameter.</param>
        /// <param name="date2">Parameter.</param>
        /// <param name="rmatn">Array parameter (length 9).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Num00a(double date1, double date1, double date2, double date2, double rmatn, double rmatn())
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Num00b(double date1, double date1, double date2, double date2, double rmatn, double rmatn())
        {
            ValidateArray(rmatn, 9, nameof(rmatn));
        ...
        /// </summary>
        /// <remarks>This method is a P/Invoke wrapper for the SOFA library function 'iauiauNum06a (P/Invoke internal)'. The
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Num06a(double date1, double date1, double date2, double date2, double rmatn, double rmatn())
        {
            ValidateArray(rmatn, 9, nameof(rmatn));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Numat(double epsa, double epsa, double dpsi, double dpsi, double deps, double deps, double rmatn, double rmatn())
        {
            ValidateArray(rmatn, 9, nameof(rmatn));
        ...
        /// </summary>
        /// <remarks>This method is a P/Invoke wrapper for the SOFA library function 'iauiauNut00a (P/Invoke internal)', which implements the IAU
        ...
        /// <param name="dpsi">Parameter.</param>
        /// <param name="deps">Parameter.</param>
        public static void Nut00a(double date1, double date1, double date2, double date2, ref ref double dpsi, ref ref double dpsi, ref ref double deps, ref ref double deps)
        {
        ...
        /// <param name="dpsi">Parameter.</param>
        /// <param name="deps">Parameter.</param>
        public static void Nut00b(double date1, double date1, double date2, double date2, ref ref double dpsi, ref ref double dpsi, ref ref double deps, ref ref double deps)
        {
        ...
        /// <param name="dpsi">Parameter.</param>
        /// <param name="deps">Parameter.</param>
        public static void Nut06a(double date1, double date1, double date2, double date2, ref ref double dpsi, ref ref double dpsi, ref ref double deps, ref ref double deps)
        {
        ...
        /// <param name="dpsi">Parameter.</param>
        /// <param name="deps">Parameter.</param>
        public static void Nut80(double date1, double date1, double date2, double date2, ref ref double dpsi, ref ref double dpsi, ref ref double deps, ref ref double deps)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Nutm80(double date1, double date1, double date2, double date2, double rmatn, double rmatn())
        {
            ValidateArray(rmatn, 9, nameof(rmatn));
        ...
        public static double Obl06(double date1, double date1, double date2, double date2)
        {
        ...
        public static double Obl80(double date1, double date1, double date2, double date2)
        {
        ...
        /// <param name="date1">Parameter.</param>
        /// <param name="date2">Parameter.</param>
        /// <param name="eps0">Parameter.</param>
        /// <param name="psia">Parameter.</param>
        /// <param name="oma">Parameter.</param>
        /// <param name="bpa">Parameter.</param>
        /// <param name="bqa">Parameter.</param>
        /// <param name="pia">Parameter.</param>
        /// <param name="bpia">Parameter.</param>
        /// <param name="epsa">Parameter.</param>
        /// <param name="chia">Parameter.</param>
        /// <param name="za">Parameter.</param>
        /// <param name="zetaa">Parameter.</param>
        /// <param name="thetaa">Parameter.</param>
        /// <param name="pa">Parameter.</param>
        /// <param name="gam">Parameter.</param>
        /// <param name="phi">Parameter.</param>
        /// <param name="psi">Parameter.</param>
        public static void P06e(double date1, double date1, double date2, double date2, ref ref double eps0, ref ref double eps0, ref ref double psia, ref ref double psia, ref ref double oma, ref ref double oma, ref ref double bpa, ref ref double bpa, ref ref double bqa, ref ref double bqa, ref ref double pia, ref ref double pia, ref ref double bpia, ref ref double bpia, ref ref double epsa, ref ref double epsa, ref ref double chia, ref ref double chia, ref ref double za, ref ref double za, ref ref double zetaa, ref ref double zetaa, ref ref double thetaa, ref ref double thetaa, ref ref double pa, ref ref double pa, ref ref double gam, ref ref double gam, ref ref double phi, ref ref double phi, ref ref double psi, ref ref double psi)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void P2pv(double p, double p(), double pv, double pv())
        {
            ValidateArray(p, 3, nameof(p));
            ValidateArray(pv, 6, nameof(pv));
        ...
        /// <param name="theta">Parameter.</param>
        /// <param name="phi">Parameter.</param>
        /// <param name="r">Parameter.</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void P2s(double p, double p(), ref ref double theta, ref ref double theta, ref ref double phi, ref ref double phi, ref ref double r, ref ref double r)
        {
            ValidateArray(p, 3, nameof(p));
        ...
        /// <param name="b">Direction 2 (length 3).</param>
        /// <returns>Parallactic angle (radians).</returns>
        /// <param name="a">Array parameter (length 3).</param>
        /// <param name="b">Array parameter (length 3).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        /// <returns>Return value from Pap</returns>
        public static double Pap(double a, double a(), double b, double b())
        {
        ...
        /// <param name="bp">Dec/latitude of second direction (radians).</param>
        /// <returns>Parallactic angle (radians).</returns>
        /// <param name="al">Parameter.</param>
        /// <param name="ap">Parameter.</param>
        /// <param name="bl">Parameter.</param>
        /// <param name="bp">Parameter.</param>
        /// <returns>Return value from Pas</returns>
        public static double Pas(double al, double al, double ap, double ap, double bl, double bl, double bp, double bp)
        {
        ...
        /// <param name="date1">Parameter.</param>
        /// <param name="date2">Parameter.</param>
        /// <param name="bzeta">Parameter.</param>
        /// <param name="bz">Parameter.</param>
        /// <param name="btheta">Parameter.</param>
        public static void Pb06(double date1, double date1, double date2, double date2, ref ref double bzeta, ref ref double bzeta, ref ref double bz, ref ref double bz, ref ref double btheta, ref ref double btheta)
        {
        ...
        public static double Pdp(double a, double a(), double b, double b())
        {
            ValidateArray(a, 3, nameof(a));
            ValidateArray(b, 3, nameof(b));
        ...
        /// <param name="gamb">Parameter.</param>
        /// <param name="phib">Parameter.</param>
        /// <param name="psib">Parameter.</param>
        /// <param name="epsa">Parameter.</param>
        public static void Pfw06(double date1, double date1, double date2, double date2, ref ref double gamb, ref ref double gamb, ref ref double phib, ref ref double phib, ref ref double psib, ref ref double psib, ref ref double epsa, ref ref double epsa)
        {
        ...
        /// <param name="date1">Parameter.</param>
        /// <param name="date2">Parameter.</param>
        /// <param name="np">Parameter.</param>
        /// <param name="pv">Array parameter (length 6).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        /// <returns>Return value from Plan94</returns>
        public static int Plan94(double date1, double date1, double date2, double date2, int np, int np, double pv, double pv())
        {
            ValidateArray(pv, 6, nameof(pv));
        ...
        public static double Pm(double p, double p())
        {
            ValidateArray(p, 3, nameof(p));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pmat00(double date1, double date1, double date2, double date2, double rbp, double rbp())
        {
            ValidateArray(rbp, 9, nameof(rbp));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pmat06(double date1, double date1, double date2, double date2, double rbp, double rbp())
        {
            ValidateArray(rbp, 9, nameof(rbp));
        ...
        /// <param name="date1">Parameter.</param>
        /// <param name="date2">Parameter.</param>
        /// <param name="rmatp">Array parameter (length 9).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pmat76(double date1, double date1, double date2, double date2, double rmatp, double rmatp())
        {
        ...
        /// <param name="a">Array parameter (length 3).</param>
        /// <param name="b">Array parameter (length 3).</param>
        /// <param name="amb">Array parameter (length 3).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pmp(double a, double a(), double b, double b(), double amb, double amb())
        {
            ValidateArray(a, 3, nameof(a));
            ValidateArray(b, 3, nameof(b));
        ...
        /// <param name="px">Parameter.</param>
        /// <param name="rv">Parameter.</param>
        /// <param name="pmt">Parameter.</param>
        /// <param name="pob">Array parameter (length 3).</param>
        /// <param name="pco">Array parameter (length 3).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pmpx(double rc, double rc, double dc, double dc, double pr, double pr, double pd, double pd, double px, double px, double rv, double rv, double pmt, double pmt, double pob, double pob(), double pco, double pco())
        {
        ...
        /// <param name="rv2">Returned radial velocity (km/s).</param>
        /// <returns>Status code: 0 = OK, &lt;0 indicates an error condition.</returns>
        /// <param name="ra1">Parameter.</param>
        /// <param name="dec1">Parameter.</param>
        /// <param name="pmr1">Parameter.</param>
        /// <param name="pmd1">Parameter.</param>
        /// <param name="px1">Parameter.</param>
        /// <param name="rv1">Parameter.</param>
        /// <param name="ep1a">Parameter.</param>
        /// <param name="ep1b">Parameter.</param>
        /// <param name="ep2a">Parameter.</param>
        /// <param name="ep2b">Parameter.</param>
        /// <param name="ra2">Parameter.</param>
        /// <param name="dec2">Parameter.</param>
        /// <param name="pmr2">Parameter.</param>
        /// <param name="pmd2">Parameter.</param>
        /// <param name="px2">Parameter.</param>
        /// <param name="rv2">Parameter.</param>
        /// <returns>Return value from Pmsafe</returns>
        public static int Pmsafe(double ra1, double ra1, double dec1, double dec1, double pmr1, double pmr1, double pmd1, double pmd1, double px1, double px1, double rv1, double rv1, double ep1a, double ep1a, double ep1b, double ep1b, double ep2a, double ep2a, double ep2b, double ep2b, ref ref double ra2, ref ref double ra2, ref ref double dec2, ref ref double dec2, ref ref double pmr2, ref ref double pmr2, ref ref double pmd2, ref ref double pmd2, ref ref double px2, ref ref double px2, ref ref double rv2, ref ref double rv2)
        {
        ...
        /// <param name="p">Array parameter (length 3).</param>
        /// <param name="r">Parameter.</param>
        /// <param name="u">Array parameter (length 3).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pn(double p, double p(), ref ref double r, ref ref double r, double u, double u())
        {
            ValidateArray(p, 3, nameof(p));
        ...
        /// <param name="rp">Array parameter (length 9).</param>
        /// <param name="rbp">Array parameter (length 9).</param>
        /// <param name="rn">Array parameter (length 9).</param>
        /// <param name="rbpn">Array parameter (length 9).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pn00(double date1, double date1, double date2, double date2, double dpsi, double dpsi, double deps, double deps, ref ref double epsa, ref ref double epsa, double rb, double rb(), double rp, double rp(), double rbp, double rbp(), double rn, double rn(), double rbpn, double rbpn())
        {
            ValidateArray(rb, 9, nameof(rb));
            ValidateArray(rp, 9, nameof(rp));
            ValidateArray(rbp, 9, nameof(rbp));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pn00a(double date1, double date1, double date2, double date2, ref ref double dpsi, ref ref double dpsi, ref ref double deps, ref ref double deps, ref ref double epsa, ref ref double epsa, double rb, double rb(), double rp, double rp(), double rbp, double rbp(), double rn, double rn(), double rbpn, double rbpn())
        {
            ValidateArray(rb, 9, nameof(rb));
            ValidateArray(rp, 9, nameof(rp));
            ValidateArray(rbp, 9, nameof(rbp));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pn00b(double date1, double date1, double date2, double date2, ref ref double dpsi, ref ref double dpsi, ref ref double deps, ref ref double deps, ref ref double epsa, ref ref double epsa, double rb, double rb(), double rp, double rp(), double rbp, double rbp(), double rn, double rn(), double rbpn, double rbpn())
        {
            ValidateArray(rb, 9, nameof(rb));
            ValidateArray(rp, 9, nameof(rp));
            ValidateArray(rbp, 9, nameof(rbp));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pn06(double date1, double date1, double date2, double date2, double dpsi, double dpsi, double deps, double deps, ref ref double epsa, ref ref double epsa, double rb, double rb(), double rp, double rp(), double rbp, double rbp(), double rn, double rn(), double rbpn, double rbpn())
        {
            ValidateArray(rb, 9, nameof(rb));
            ValidateArray(rp, 9, nameof(rp));
            ValidateArray(rbp, 9, nameof(rbp));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pn06a(double date1, double date1, double date2, double date2, ref ref double dpsi, ref ref double dpsi, ref ref double deps, ref ref double deps, ref ref double epsa, ref ref double epsa, double rb, double rb(), double rp, double rp(), double rbp, double rbp(), double rn, double rn(), double rbpn, double rbpn())
        {
            ValidateArray(rb, 9, nameof(rb));
            ValidateArray(rp, 9, nameof(rp));
            ValidateArray(rbp, 9, nameof(rbp));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pnm00a(double date1, double date1, double date2, double date2, double rbpn, double rbpn())
        {
            ValidateArray(rbpn, 9, nameof(rbpn));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pnm00b(double date1, double date1, double date2, double date2, double rbpn, double rbpn())
        {
            ValidateArray(rbpn, 9, nameof(rbpn));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pnm06a(double date1, double date1, double date2, double date2, double rnpb, double rnpb())
        {
            ValidateArray(rnpb, 9, nameof(rnpb));
        ...
        /// <param name="date1">Parameter.</param>
        /// <param name="date2">Parameter.</param>
        /// <param name="rmatpn">Array parameter (length 9).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pnm80(double date1, double date1, double date2, double date2, double rmatpn, double rmatpn())
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pom00(double xp, double xp, double yp, double yp, double sp, double sp, double rpom, double rpom())
        {
            ValidateArray(rpom, 9, nameof(rpom));
        ...
        /// <param name="a">Array parameter (length 3).</param>
        /// <param name="b">Array parameter (length 3).</param>
        /// <param name="apb">Array parameter (length 3).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Ppp(double a, double a(), double b, double b(), double apb, double apb())
        {
            ValidateArray(a, 3, nameof(a));
            ValidateArray(b, 3, nameof(b));
        ...
        /// <param name="s">Parameter.</param>
        /// <param name="b">Array parameter (length 3).</param>
        /// <param name="apsb">Array parameter (length 3).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Ppsp(double a, double a(), double s, double s, double b, double b(), double apsb, double apsb())
        {
            ValidateArray(a, 3, nameof(a));
            ValidateArray(b, 3, nameof(b));
        ...
        /// <param name="date1">Parameter.</param>
        /// <param name="date2">Parameter.</param>
        /// <param name="dpsipr">Parameter.</param>
        /// <param name="depspr">Parameter.</param>
        public static void Pr00(double date1, double date1, double date2, double date2, ref ref double dpsipr, ref ref double dpsipr, ref ref double depspr, ref ref double depspr)
        {
        ...
        /// <param name="z">Returned Fukushima-Williams angle z (radians).</param>
        /// <param name="theta">Returned Fukushima-Williams angle theta (radians).</param>
        /// <param name="date01">Parameter.</param>
        /// <param name="date02">Parameter.</param>
        /// <param name="date11">Parameter.</param>
        /// <param name="date12">Parameter.</param>
        /// <param name="zeta">Parameter.</param>
        /// <param name="z">Parameter.</param>
        /// <param name="theta">Parameter.</param>
        public static void Prec76(double date01, double date01, double date02, double date02, double date11, double date11, double date12, double date12, ref ref double zeta, ref ref double zeta, ref ref double z, ref ref double z, ref ref double theta, ref ref double theta)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pv2p(double pv, double pv(), double p, double p())
        {
            ValidateArray(pv, 6, nameof(pv));
            ValidateArray(p, 3, nameof(p));
        ...
        /// <param name="phi">Parameter.</param>
        /// <param name="r">Parameter.</param>
        /// <param name="td">Parameter.</param>
        /// <param name="pd">Parameter.</param>
        /// <param name="rd">Parameter.</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pv2s(double pv, double pv(), ref ref double theta, ref ref double theta, ref ref double phi, ref ref double phi, ref ref double r, ref ref double r, ref ref double td, ref ref double td, ref ref double pd, ref ref double pd, ref ref double rd, ref ref double rd)
        {
            ValidateArray(pv, 6, nameof(pv));
        ...
        /// <param name="b">Second position-velocity vector (length 6).</param>
        /// <param name="adb">Returned dot products (length 2): position·position and velocity·velocity.</param>
        /// <param name="a">Array parameter (length 6).</param>
        /// <param name="b">Array parameter (length 6).</param>
        /// <param name="adb">Array parameter (length 2).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pvdpv(double a, double a(), double b, double b(), double adb, double adb())
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pvm(double pv, double pv(), ref ref double r, ref ref double r, ref ref double s, ref ref double s)
        {
            ValidateArray(pv, 6, nameof(pv));
        ...
        /// <param name="a">Array parameter (length 6).</param>
        /// <param name="b">Array parameter (length 6).</param>
        /// <param name="amb">Array parameter (length 6).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pvmpv(double a, double a(), double b, double b(), double amb, double amb())
        {
            ValidateArray(a, 6, nameof(a));
            ValidateArray(b, 6, nameof(b));
        ...
        /// <param name="a">Array parameter (length 6).</param>
        /// <param name="b">Array parameter (length 6).</param>
        /// <param name="apb">Array parameter (length 6).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pvppv(double a, double a(), double b, double b(), double apb, double apb())
        {
            ValidateArray(a, 6, nameof(a));
            ValidateArray(b, 6, nameof(b));
        ...
        /// <param name="ra">Parameter.</param>
        /// <param name="dec">Parameter.</param>
        /// <param name="pmr">Parameter.</param>
        /// <param name="pmd">Parameter.</param>
        /// <param name="px">Parameter.</param>
        /// <param name="rv">Parameter.</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        /// <returns>Return value from Pvstar</returns>
        public static int Pvstar(double pv, double pv(), ref ref double ra, ref ref double ra, ref ref double dec, ref ref double dec, ref ref double pmr, ref ref double pmr, ref ref double pmd, ref ref double pmd, ref ref double px, ref ref double px, ref ref double rv, ref ref double rv)
        {
            ValidateArray(pv, 6, nameof(pv));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pvtob(double elong, double elong, double phi, double phi, double height, double height, double xp, double xp, double yp, double yp, double sp, double sp, double theta, double theta, double pv, double pv())
        {
            ValidateArray(pv, 6, nameof(pv));
        ...
        /// <param name="pv">Position-velocity vector at the start epoch (length 6).</param>
        /// <param name="upv">Returned updated position-velocity vector (length 6).</param>
        /// <param name="dt">Parameter.</param>
        /// <param name="pv">Array parameter (length 6).</param>
        /// <param name="upv">Array parameter (length 6).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pvu(double dt, double dt, double pv, double pv(), double upv, double upv())
        {
            ValidateArray(pv, 6, nameof(pv));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pvup(double dt, double dt, double pv, double pv(), double p, double p())
        {
            ValidateArray(pv, 6, nameof(pv));
            ValidateArray(p, 3, nameof(p));
        ...
        /// <param name="a">Array parameter (length 6).</param>
        /// <param name="b">Array parameter (length 6).</param>
        /// <param name="axb">Array parameter (length 6).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pvxpv(double a, double a(), double b, double b(), double axb, double axb())
        {
            ValidateArray(a, 6, nameof(a));
            ValidateArray(b, 6, nameof(b));
        ...
        /// <param name="a">Array parameter (length 3).</param>
        /// <param name="b">Array parameter (length 3).</param>
        /// <param name="axb">Array parameter (length 3).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Pxp(double a, double a(), double b, double b(), double axb, double axb())
        {
            ValidateArray(a, 3, nameof(a));
            ValidateArray(b, 3, nameof(b));
        ...
        /// <param name="refa">Parameter.</param>
        /// <param name="refb">Parameter.</param>
        public static void Refco(double phpa, double phpa, double tc, double tc, double rh, double rh, double wl, double wl, ref ref double refa, ref ref double refa, ref ref double refb, ref ref double refb)
        {
        ...
        /// <param name="w">Returned rotation vector (length 3).</param>
        /// <param name="r">Array parameter (length 9).</param>
        /// <param name="w">Array parameter (length 3).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Rm2v(double r, double r(), double w, double w())
        {
            ValidateArray(r, 9, nameof(r));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Rv2m(double w, double w(), double r, double r())
        {
            ValidateArray(w, 3, nameof(w));
            ValidateArray(r, 9, nameof(r));
        ...
        /// </summary>
        /// <remarks>This method is a P/Invoke wrapper for the SOFA library function 'iauiauRx (P/Invoke internal)'. The resulting
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Rx(double phi, double phi, double r, double r())
        {
            ValidateArray(r, 9, nameof(r));
        ...
        /// <param name="r">Array parameter (length 9).</param>
        /// <param name="p">Array parameter (length 3).</param>
        /// <param name="rp">Array parameter (length 3).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Rxp(double r, double r(), double p, double p(), double rp, double rp())
        {
            ValidateArray(r, 9, nameof(r));
            ValidateArray(p, 3, nameof(p));
        ...
        /// <param name="r">Array parameter (length 9).</param>
        /// <param name="pv">Array parameter (length 6).</param>
        /// <param name="rpv">Array parameter (length 6).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Rxpv(double r, double r(), double pv, double pv(), double rpv, double rpv())
        {
            ValidateArray(r, 9, nameof(r));
            ValidateArray(pv, 6, nameof(pv));
        ...
        /// <param name="b">Second 3×3 matrix (row-major, length 9).</param>
        /// <param name="atb">Returned product matrix (row-major, length 9).</param>
        /// <param name="a">Array parameter (length 9).</param>
        /// <param name="b">Array parameter (length 9).</param>
        /// <param name="atb">Array parameter (length 9).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Rxr(double a, double a(), double b, double b(), double atb, double atb())
        {
        ...
        /// </summary>
        /// <remarks>This method is a P/Invoke wrapper for the SOFA library function 'iauiauRy (P/Invoke internal)'. The
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Ry(double theta, double theta, double r, double r())
        {
            ValidateArray(r, 9, nameof(r));
        ...
        /// for the IAU SOFA library's iauiauRz (P/Invoke internal) routine.</remarks>
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Rz(double psi, double psi, double r, double r())
        {
            ValidateArray(r, 9, nameof(r));
        ...
        public static double S00(double date1, double date1, double date2, double date2, double x, double x, double y, double y)
        {
        ...
        public static double S00a(double date1, double date1, double date2, double date2)
        {
        ...
        public static double S00b(double date1, double date1, double date2, double date2)
        {
        ...
        public static double S06(double date1, double date1, double date2, double date2, double x, double x, double y, double y)
        {
        ...
        public static double S06a(double date1, double date1, double date2, double date2)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void S2c(double theta, double theta, double phi, double phi, double c, double c())
        {
            ValidateArray(c, 3, nameof(c));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void S2p(double theta, double theta, double phi, double phi, double r, double r, double p, double p())
        {
            ValidateArray(p, 3, nameof(p));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void S2pv(double theta, double theta, double phi, double phi, double r, double r, double td, double td, double pd, double pd, double rd, double rd, double pv, double pv())
        {
            ValidateArray(pv, 6, nameof(pv));
        ...
        /// <param name="pv">Input position-velocity vector (length 6).</param>
        /// <param name="spv">Returned scaled position-velocity vector (length 6).</param>
        /// <param name="s1">Parameter.</param>
        /// <param name="s2">Parameter.</param>
        /// <param name="pv">Array parameter (length 6).</param>
        /// <param name="spv">Array parameter (length 6).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void S2xpv(double s1, double s1, double s2, double s2, double pv, double pv(), double spv, double spv())
        {
            ValidateArray(pv, 6, nameof(pv));
        ...
        public static double Sepp(double a, double a(), double b, double b())
        {
            ValidateArray(a, 3, nameof(a));
            ValidateArray(b, 3, nameof(b));
        ...
        public static double Seps(double al, double al, double ap, double ap, double bl, double bl, double bp, double bp)
        {
        ...
        public static double Sp00(double date1, double date1, double date2, double date2)
        {
        ...
        public static int Starpm(double ra1, double ra1, double dec1, double dec1, double pmr1, double pmr1, double pmd1, double pmd1, double px1, double px1, double rv1, double rv1, double ep1a, double ep1a, double ep1b, double ep1b, double ep2a, double ep2a, double ep2b, double ep2b, ref ref double ra2, ref ref double ra2, ref ref double dec2, ref ref double dec2, ref ref double pmr2, ref ref double pmr2, ref ref double pmd2, ref ref double pmd2, ref ref double px2, ref ref double px2, ref ref double rv2, ref ref double rv2)
        {
        ...
        public static int Starpv(double ra, double ra, double dec, double dec, double pmr, double pmr, double pmd, double pmd, double px, double px, double rv, double rv, double pv, double pv())
        {
            ValidateArray(pv, 6, nameof(pv));
        ...
        /// <param name="s">Parameter.</param>
        /// <param name="p">Array parameter (length 3).</param>
        /// <param name="sp">Array parameter (length 3).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Sxp(double s, double s, double p, double p(), double sp, double sp())
        {
            ValidateArray(p, 3, nameof(p));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Sxpv(double s, double s, double pv, double pv(), double spv, double spv())
        {
            ValidateArray(pv, 6, nameof(pv));
            ValidateArray(spv, 6, nameof(spv));
        ...
        /// </list>
        /// </remarks>
        /// <param name="tai1">Parameter.</param>
        /// <param name="tai2">Parameter.</param>
        /// <param name="tt1">Parameter.</param>
        /// <param name="tt2">Parameter.</param>
        /// <returns>Return value from Taitt</returns>
        public static short Taitt(double tai1, double tai1, double tai2, double tai2, ref ref double tt1, ref ref double tt1, ref ref double tt2, ref ref double tt2)
        {
        ...
        /// <param name="tai1">Parameter.</param>
        /// <param name="tai2">Parameter.</param>
        /// <param name="dta">Parameter.</param>
        /// <param name="ut11">Parameter.</param>
        /// <param name="ut12">Parameter.</param>
        /// <returns>Return value from Taiut1</returns>
        public static int Taiut1(double tai1, double tai1, double tai2, double tai2, double dta, double dta, ref ref double ut11, ref ref double ut11, ref ref double ut12, ref ref double ut12)
        {
        ...
        public static short Taiutc(double tai1, double tai1, double tai2, double tai2, ref ref double utc1, ref ref double utc1, ref ref double utc2, ref ref double utc2)
        {
        ...
        /// <param name="tdb2">Returned TDB as a 2-part Julian Date (part 2).</param>
        /// <returns>Status: 0 = OK.</returns>
        /// <param name="tcb1">Parameter.</param>
        /// <param name="tcb2">Parameter.</param>
        /// <param name="tdb1">Parameter.</param>
        /// <param name="tdb2">Parameter.</param>
        /// <returns>Return value from Tcbtdb</returns>
        public static int Tcbtdb(double tcb1, double tcb1, double tcb2, double tcb2, ref ref double tdb1, ref ref double tdb1, ref ref double tdb2, ref ref double tdb2)
        {
        ...
        /// <param name="tt2">Returned TT as a 2-part Julian Date (part 2).</param>
        /// <returns>Status: 0 = OK.</returns>
        /// <param name="tcg1">Parameter.</param>
        /// <param name="tcg2">Parameter.</param>
        /// <param name="tt1">Parameter.</param>
        /// <param name="tt2">Parameter.</param>
        /// <returns>Return value from Tcgtt</returns>
        public static int Tcgtt(double tcg1, double tcg1, double tcg2, double tcg2, ref ref double tt1, ref ref double tt1, ref ref double tt2, ref ref double tt2)
        {
        ...
        public static int Tdbtcb(double tdb1, double tdb1, double tdb2, double tdb2, ref ref double tcb1, ref ref double tcb1, ref ref double tcb2, ref ref double tcb2)
        {
        ...
        /// <param name="tdb1">Parameter.</param>
        /// <param name="tdb2">Parameter.</param>
        /// <param name="dtr">Parameter.</param>
        /// <param name="tt1">Parameter.</param>
        /// <param name="tt2">Parameter.</param>
        /// <returns>Return value from Tdbtt</returns>
        public static int Tdbtt(double tdb1, double tdb1, double tdb2, double tdb2, double dtr, double dtr, ref ref double tt1, ref ref double tt1, ref ref double tt2, ref ref double tt2)
        {
        ...
        /// </remarks>
        /// <param name="s">Parameter.</param>
        /// <param name="ihour">Parameter.</param>
        /// <param name="imin">Parameter.</param>
        /// <param name="sec">Parameter.</param>
        /// <param name="rad">Parameter.</param>
        /// <returns>Return value from Tf2a</returns>
        public static short Tf2a(char s, char s, short ihour, short ihour, short imin, short imin, double sec, double sec, ref ref double rad, ref ref double rad)
        {
        ...
        public static int Tf2d(char s, char s, int ihour, int ihour, int imin, int imin, double sec, double sec, ref ref double days, ref ref double days)
        {
        ...
        /// <param name="eta">Parameter.</param>
        /// <param name="a">Parameter.</param>
        /// <param name="b">Parameter.</param>
        /// <param name="a01">Parameter.</param>
        /// <param name="b01">Parameter.</param>
        /// <param name="a02">Parameter.</param>
        /// <param name="b02">Parameter.</param>
        /// <returns>Return value from Tpors</returns>
        public static int Tpors(double xi, double xi, double eta, double eta, double a, double a, double b, double b, ref ref double a01, ref ref double a01, ref ref double b01, ref ref double b01, ref ref double a02, ref ref double a02, ref ref double b02, ref ref double b02)
        {
        ...
        /// <param name="eta">Parameter.</param>
        /// <param name="v">Array parameter (length 3).</param>
        /// <param name="v01">Array parameter (length 3).</param>
        /// <param name="v02">Array parameter (length 3).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        /// <returns>Return value from Tporv</returns>
        public static int Tporv(double xi, double xi, double eta, double eta, double v, double v(), double v01, double v01(), double v02, double v02())
        {
            ValidateArray(v, 3, nameof(v));
        ...
        /// <param name="xi">Parameter.</param>
        /// <param name="eta">Parameter.</param>
        /// <param name="a0">Parameter.</param>
        /// <param name="b0">Parameter.</param>
        /// <param name="a">Parameter.</param>
        /// <param name="b">Parameter.</param>
        public static void Tpsts(double xi, double xi, double eta, double eta, double a0, double a0, double b0, double b0, ref ref double a, ref ref double a, ref ref double b, ref ref double b)
        {
        ...
        /// <param name="xi">Parameter.</param>
        /// <param name="eta">Parameter.</param>
        /// <param name="v0">Array parameter (length 3).</param>
        /// <param name="v">Array parameter (length 3).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Tpstv(double xi, double xi, double eta, double eta, double v0, double v0(), double v, double v())
        {
        ...
        public static int Tpxes(double a, double a, double b, double b, double a0, double a0, double b0, double b0, ref ref double xi, ref ref double xi, ref ref double eta, ref ref double eta)
        {
        ...
        public static int Tpxev(double v, double v(), double v0, double v0(), ref ref double xi, ref ref double xi, ref ref double eta, ref ref double eta)
        {
            ValidateArray(v, 3, nameof(v));
            ValidateArray(v0, 3, nameof(v0));
        ...
        /// <summary>
        /// iauTr (P/Invoke internal)anspose a 3x3 matrix.
        /// </summary>
        ...
        /// <param name="rt">Returned transpose (row-major, length 9).</param>
        /// <param name="r">Array parameter (length 9).</param>
        /// <param name="rt">Array parameter (length 9).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Tr(double r, double r(), double rt, double rt())
        {
            ValidateArray(r, 9, nameof(r));
        ...
        /// <param name="r">Array parameter (length 9).</param>
        /// <param name="p">Array parameter (length 3).</param>
        /// <param name="trp">Array parameter (length 3).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Trxp(double r, double r(), double p, double p(), double trp, double trp())
        {
            ValidateArray(r, 9, nameof(r));
            ValidateArray(p, 3, nameof(p));
        ...
        /// <param name="r">Array parameter (length 9).</param>
        /// <param name="pv">Array parameter (length 6).</param>
        /// <param name="trpv">Array parameter (length 6).</param>
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Trxpv(double r, double r(), double pv, double pv(), double trpv, double trpv())
        {
            ValidateArray(r, 9, nameof(r));
            ValidateArray(pv, 6, nameof(pv));
        ...
        public static short Tttai(double tt1, double tt1, double tt2, double tt2, ref ref double tai1, ref ref double tai1, ref ref double tai2, ref ref double tai2)
        {
        ...
        public static int Tttcg(double tt1, double tt1, double tt2, double tt2, ref ref double tcg1, ref ref double tcg1, ref ref double tcg2, ref ref double tcg2)
        {
        ...
        public static int Tttdb(double tt1, double tt1, double tt2, double tt2, double dtr, double dtr, ref ref double tdb1, ref ref double tdb1, ref ref double tdb2, ref ref double tdb2)
        {
        ...
        public static int Ttut1(double tt1, double tt1, double tt2, double tt2, double dt, double dt, ref ref double ut11, ref ref double ut11, ref ref double ut12, ref ref double ut12)
        {
        ...
        public static int Ut1tai(double ut11, double ut11, double ut12, double ut12, double dta, double dta, ref ref double tai1, ref ref double tai1, ref ref double tai2, ref ref double tai2)
        {
        ...
        public static int Ut1tt(double ut11, double ut11, double ut12, double ut12, double dt, double dt, ref ref double tt1, ref ref double tt1, ref ref double tt2, ref ref double tt2)
        {
        ...
        public static int Ut1utc(double ut11, double ut11, double ut12, double ut12, double dut1, double dut1, ref ref double utc1, ref ref double utc1, ref ref double utc2, ref ref double utc2)
        {
        ...
        public static short Utctai(double utc1, double utc1, double utc2, double utc2, ref ref double tai1, ref ref double tai1, ref ref double tai2, ref ref double tai2)
        {
        ...
        public static int Utcut1(double utc1, double utc1, double utc2, double utc2, double dut1, double dut1, ref ref double ut11, ref ref double ut11, ref ref double ut12, ref ref double ut12)
        {
        ...
        /// <param name="x">Parameter.</param>
        /// <param name="y">Parameter.</param>
        public static void Xy06(double date1, double date1, double date2, double date2, ref ref double x, ref ref double x, ref ref double y, ref ref double y)
        {
        ...
        /// <param name="y">Parameter.</param>
        /// <param name="s">Parameter.</param>
        public static void Xys00a(double date1, double date1, double date2, double date2, ref ref double x, ref ref double x, ref ref double y, ref ref double y, ref ref double s, ref ref double s)
        {
        ...
        /// <param name="y">Parameter.</param>
        /// <param name="s">Parameter.</param>
        public static void Xys00b(double date1, double date1, double date2, double date2, ref ref double x, ref ref double x, ref ref double y, ref ref double y, ref ref double s, ref ref double s)
        {
        ...
        /// <param name="y">Parameter.</param>
        /// <param name="s">Parameter.</param>
        public static void Xys06a(double date1, double date1, double date2, double date2, ref ref double x, ref ref double x, ref ref double y, ref ref double y, ref ref double s, ref ref double s)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Zp(double p, double p())
        {
            ValidateArray(p, 3, nameof(p));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Zpv(double pv, double pv())
        {
            ValidateArray(pv, 6, nameof(pv));
        ...
        /// <exception cref="ArgumentNullException">Thrown if any array parameter is null.</exception>
        /// <exception cref="ArgumentException">Thrown if any array parameter has incorrect length.</exception>
        public static void Zr(double r, double r())
        {
            ValidateArray(r, 9, nameof(r));
