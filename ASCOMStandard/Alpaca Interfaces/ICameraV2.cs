...
namespace ASCOM.Alpaca.Interfaces
{
    ...
    public interface ICameraV2 : IAscomDriver
    {
        ...
        ///     ''' <exception cref="T:ASCOM.AlpacaException">Thrown if a communications error occurs, or if the abort fails.</exception>
        void AbortExposure();
        ...
        ///     ''' <exception cref="NotImplementedException">Must throw an exception if PercentCompleted is not supported</exception>
