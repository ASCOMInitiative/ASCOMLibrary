...
namespace ASCOM.Alpaca.Clients
{
    ...
    public static class AlpacaClient
    {
        ...
        internal const int CLIENT_ESTABLISHCONNECTIONTIMEOUT_DEFAULT = 3; // Default establish connection timeout
        internal const int CLIENT_STANDARDCONNECTIONTIMEOUT_DEFAULT = 3; // Default standard command timeout
