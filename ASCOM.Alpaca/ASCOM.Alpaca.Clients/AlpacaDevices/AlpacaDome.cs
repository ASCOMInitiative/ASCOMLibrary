...
namespace ASCOM.Alpaca.Clients
{
    ...
    public class AlpacaDome : AlpacaDeviceBaseClass, IDomeV2
    {
        ...
        /// <summary>
        /// Create an Alpaca Dome device with all values set to default
        /// </summary>
        public AlpacaDome()
        {
            Initialise();
        ...
        /// <summary>
        /// Create an Alpaca Dome device specifying the minimum required parameters, others will have default values
        /// </summary>
        public AlpacaDome(ServiceType serviceType,
                         string ipAddressString,
                         int portNumber,
