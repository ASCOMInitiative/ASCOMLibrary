...
namespace ASCOM.Alpaca.Clients
{
    ...
    public class AlpacaTelescope : AlpacaDeviceBaseClass, ITelescopeV3
    {
        ...
        /// <summary>
        /// Create an Alpaca Telescope device with all values set to default
        /// </summary>
        ...
        /// <summary>
        /// Create an Alpaca Telescope device specifying the minimum required parameters, others will have default values
        /// </summary>
        public AlpacaTelescope(ServiceType serviceType,
                         string ipAddressString,
                         int portNumber,
