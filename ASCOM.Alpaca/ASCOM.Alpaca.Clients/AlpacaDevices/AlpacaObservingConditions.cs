...
namespace ASCOM.Alpaca.Clients
{
    ...
    public class AlpacaObservingConditions : AlpacaDeviceBaseClass, IObservingConditions
    {
        ...
        /// <summary>
        /// Create an ObservingConditions device with all values set to default
        /// </summary>
        ...
        /// <summary>
        /// Create an Alpaca ObservingConditions device specifying the minimum required parameters, others will have default values
        /// </summary>
        public AlpacaObservingConditions(ServiceType serviceType,
                         string ipAddressString,
                         int portNumber,
