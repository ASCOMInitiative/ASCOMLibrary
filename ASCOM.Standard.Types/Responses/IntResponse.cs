namespace ASCOM.Standard.Responses
{
    ...
    public class IntResponse : Response, IValueResponse<int>
    {
        ...
        public IntResponse(uint clientTransactionID, uint serverTransactionID, int value)
        {
        ...
        public IntResponse(uint clientTransactionID, uint serverTransactionID, string errorMessage, ErrorCodes errorCode)
        {
            base.ServerTransactionID = serverTransactionID;
            base.ClientTransactionID = clientTransactionID;
